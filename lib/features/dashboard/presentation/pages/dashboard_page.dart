...
class _DashboardPageState extends State<DashboardPage> {
  ...
  final List<_CategoryItem> _categories = const [
    _CategoryItem(label: 'Semua', icon: Icons.apps),
    _CategoryItem(label: 'Makanan', icon: Icons.fastfood),
    _CategoryItem(label: 'Minuman', icon: Icons.local_drink),
    _CategoryItem(label: 'Sembako', icon: Icons.kitchen),
  ];
            ...
            _BottomNav(
              ...
              onTap: (i) {
                if (i == 1) {
                  ...
                  //Order -> navigate to MyOrderPage
                  Navigator.pushNamed(context, AppRouter.myOrders).then((_) {
                    if (context.mounted) {
...
//           colors: [Color(0xFF4CD137), Color(0xFF6EEB5A)],
                ...
                children: [
                  ClipRRect(
                    ...
                    child: p.imageUrl.isNotEmpty
                        ? Image.network(
                            "http://192.168.1.12:8082/${p.imageUrl}",
...
class _BottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const items = [
      ...
      _NavItem(icon: Icons.receipt_long_outlined, label: 'Pesanan'),
