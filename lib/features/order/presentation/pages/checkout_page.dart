...
void _log(String msg) => debugPrint('[JajanSkuy/Checkout] $msg');
...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  static const List<_PaymentOption> _paymentOptions = [
    _PaymentOption(
      value: 'global_institute_pay', // value dikirim ke be-emoney
      label: 'Global Institute Pay', // label tampilan
  ...
  Future<void> _placeOrder(BuildContext context) async {
    ...
    if (success) {
      ...
      /*needsPaymentFlow menentukan apakah pengguna diarahkan ke PaymentPendingPage
        (untuk metode yang butuh tindakan lanjutan) atau langsung ke OrderSuccessPage
        (untuk transfer bank yang tidak butuh konfirmasi real-time).*/
