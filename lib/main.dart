...
void main() async {
  ...
  await GlobalInstitutePayService().init(); //Panggil class GlobalInstitutePayService sebelum runApp() agar cold start callback tertangkap. Jika dipanggil setelah runApp(), URI bisa hilang.
